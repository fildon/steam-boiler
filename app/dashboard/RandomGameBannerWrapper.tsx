...
export function RandomGameBannerWrapper({ games, label, tooltip }: { games: OwnedGame[]; label?: string; tooltip?: string }) {
  return <RandomGameBanner games={games} label={label} tooltip={tooltip} />;
}
